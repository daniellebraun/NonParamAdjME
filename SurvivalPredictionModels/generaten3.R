...
dat$ertimepfs[which(dat$ertimepfs>24)]<-25
...
#for those who had no PFS event, suppose 10% of them died, assume on average died 5 years after PFS, OS=PFS+N(48,5)
...
write.table(dat, paste(getwd(),"/temp",a,b,"/temp",k,"/N3.txt", sep=""), sep="\t")
}}}
